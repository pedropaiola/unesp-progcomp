...
{
    long long i = lower_bound(posAvenger.begin(), posAvenger.end(), e) - posAvenger.begin(); //posi��o do primeiro vingador, se tiver no intervalo
    long long j = upper_bound(posAvenger.begin(), posAvenger.end(), d) - posAvenger.begin(); //posi��o do ultimo vingador
    j--;
